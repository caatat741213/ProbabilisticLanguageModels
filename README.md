...
## 📖 Project Description
This project is an NLP (Natural Language Processing) workshop. We implemented **Unigram** and **Bigram** probabilistic models to estimate the probability of sentences based on a specific text corpus.
...
* **Author:** J.K. Rowling
* **Vocabulary Size:** Approximately 6,002 unique words (after normalization).
...
4. **Inverted Index:** Maps each unique word to all positions it appears in the corpus.
...
```bash
git clone https://github.com/caatat741213/ProbabilisticLanguageModels.git
